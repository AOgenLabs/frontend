                ...
                case "telegram-receive": {
                    try {
                                ...
                                if (recentFiles.length > 0) {
                                    ...
                                    console.log(
                                        `Processing latest file: ${
                                            latestFile.fileName || latestFile.id
                                        }`
                                    );
                                    ...
                                    for (const edge of outgoingEdges) {
                                        ...
                                        console.log(
                                            `Sending latest file to node: ${
                                                targetNode?.data.label ||
                                                edge.target
                                            }`
                                        );
                                        await get().executeNode(
                                            edge.target,
                                            latestFile
                                        );
                                    }
                        ...
                        telegramHandler.startPolling(async (fileData: any) => {
                            console.log(
                                "New file detected from Telegram:",
                                fileData
                            );
                        ...
                        console.error(
                            `Error initializing Telegram node ${nodeId}:`,
                            error
                        );
                ...
                case "telegram": {
                    try {
                        ...
                        for (const edge of outgoingEdges) {
                            ...
                            console.log(
                                `Passing Telegram send result to node: ${
                                    targetNode?.data.label || edge.target
                                }`
                            );
                ...
                case "arweave-upload": {
                    try {
                        ...
                        for (const edge of outgoingEdges) {
                            ...
                            console.log(
                                `Passing Arweave result to node: ${
                                    targetNode?.data.label || edge.target
                                }`
                            );
